module Account::Linkable
  ...
  included do
    ...
    belongs_to :tink_account, optional: true
  end

  # A "linked" account gets transaction and balance data from a third party like Plaid or Tink
  def linked?
    plaid_account_id.present? || tink_account_id.present?
  end
